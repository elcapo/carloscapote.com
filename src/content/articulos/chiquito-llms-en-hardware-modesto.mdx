...
En este artículo te hablo sobre **Chiquito**, un repositorio que he creado inspirado por [AirLLM](https://github.com/lyogavin/airllm), de [Gavin Li](https://github.com/lyogavin), y que propone una técnica para poder cargar modelos bastante más grandes que la memoria VRAM disponible: cargarlos poco a poco.
