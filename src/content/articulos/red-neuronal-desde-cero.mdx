...
En las pruebas que hice con MNIST, esta red alcanza alrededor del 87% de precisión en el conjunto de test. No está mal para 400 líneas de código en Python puro.
...
> PD: Si te animas a experimentar, el código completo con tests, evaluación y visualizaciones está en [nn-from-scratch](https://github.com/elcapo/nn-from-scratch). Y si quieres ver la matemática en detalle, hay un documento dedicado a las derivadas de softmax.
